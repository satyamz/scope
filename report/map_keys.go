...
const (
	...
	KubernetesControllerLabel        = "kubernetes_labels_openebs/controller"
	KubernetesControllerServiceLabel = "kubernetes_labels_openebs/controller-service"
	KubernetesReplicaLabel           = "kubernetes_labels_openebs/replica"
	// probe/awsecs
