...
const (
	...
	ControllerLabel        = report.KubernetesControllerLabel
	ControllerServiceLabel = report.KubernetesControllerServiceLabel
	ReplicaLabel           = report.KubernetesReplicaLabel
)
